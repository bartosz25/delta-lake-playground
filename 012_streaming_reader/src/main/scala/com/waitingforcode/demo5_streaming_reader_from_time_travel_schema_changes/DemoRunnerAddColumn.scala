...
object DemoRunnerAddColumn {
  ...
  def main(args: Array[String]): Unit = {
    ...
    sparkSession.sql(s"ALTER TABLE ${NumbersWithLettersTable} ADD COLUMN id_number INT")
    println("...version 5")
    getNumbers(5).withColumn("id_number", functions.lit(3))
      .write.format("delta").insertInto(NumbersWithLettersTable)
